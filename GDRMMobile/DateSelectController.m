...
{
    [super viewDidLoad];
//    if (self.view.frame.size.width >150) {
//        self.view.frame = CGRectMake(self.view.frame.origin.x, self.view.frame.origin.y, 150, self.view.frame.size.height);
//    }
//    if (self.view.frame.size.height >200) {
//        self.view.frame = CGRectMake(self.view.frame.origin.x, self.view.frame.origin.y,self.view.frame.size.width,200);
//    }
}
...
- (IBAction)btnSave:(id)sender {
    if(self.setDataBolck!=nil){
        self.setDataBolck( [self.datePicker date] );
