...
//    NSSortDescriptor *sortByCaseMark3=[NSSortDescriptor sortDescriptorWithKey:@"case_mark3.integerValue" ascending:YES];
    NSSortDescriptor *sortByCaseMark = [NSSortDescriptor sortDescriptorWithKey:@"happen_date" ascending:NO];
    NSArray *sortArray=[NSArray arrayWithObjects:sortByCaseMark,nil];
