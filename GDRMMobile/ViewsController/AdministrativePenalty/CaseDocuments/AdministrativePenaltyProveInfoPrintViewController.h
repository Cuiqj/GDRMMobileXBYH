...
@property (weak, nonatomic) IBOutlet UITextField *TextSex;          //当事人性别
@property (weak, nonatomic) IBOutlet UITextField *TextCardNumber;   //身份证号
@property (weak, nonatomic) IBOutlet UITextField *TextAddress;      //住址
@property (weak, nonatomic) IBOutlet UITextField *TextTelephone;    //联系电话
