...
//            [[self.TableMapping objectForKey:self.fileName] isEqualToString:@"AtonementNoticeTable"] ||[[self.TableMapping objectForKey:self.fileName] isEqualToString:@"AdminstrativePenaltyConstructionTable"] || [[self.TableMapping objectForKey:self.fileName] isEqualToString:@"AdminstrativePenaltyServiceReceiptTable"]){
//            [self.uiButtonPrintFull removeFromSuperview];
        if ([[self.TableMapping objectForKey:self.fileName] isEqualToString:@"CaseCountTable"] ||
                       [[self.TableMapping objectForKey:self.fileName] isEqualToString:@"AtonementNoticeTable"] || [[self.TableMapping objectForKey:self.fileName] isEqualToString:@"AdminstrativePenaltyServiceReceiptTable"]  || [[self.TableMapping objectForKey:self.fileName] isEqualToString:@"AdminstrativePenaltyConstructionTable"]){
            [self.uiButtonPrintFull removeFromSuperview];     //删除打印
        }else{
...
//                    [[NSUserDefaults standardUserDefaults] setObject:@"UserDidSelect" forKey:@"Selected"];
////                    if ([[NSUserDefaults standardUserDefaults] objectForKey:@"Selected"]) {
//                        GSignInConfig.airPrinterUrlStr = printer.selectedPrinter.URL.absoluteString;
//                        GSignInConfig.airPrinterName = printer.selectedPrinter.displayName;
//                    }
                };
